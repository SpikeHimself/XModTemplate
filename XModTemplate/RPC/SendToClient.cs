namespace XModTemplate.RPC
{
    internal static class SendToClient
    {
        ...
        internal static void ExampleRequestDenied(long clientPeerID, string request, string reason)
        {
        ...
        internal static void ExampleRequestGranted(long clientPeerID, string request)
        {
